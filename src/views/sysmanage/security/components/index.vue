<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="queryEntity.flag" size="small" placeholder="是否异常" style="width: 100px" class="filter-item">
      ...
      <el-button class="filter-item" size="small" type="primary" icon="el-icon-search" @click="resetLog">
        重置
      </el-button>
    </div>
    ...
    <el-dialog v-dialogDrag append-to-body title="日志详情" :visible.sync="dialogFormVisible" style="height:1000px">
        ...
        <el-row type="flex" justify="start">
          ...
          <el-col :span="10">
            <el-form-item label="操作时间" :label-width="formLabelWidth">
              <el-date-picker v-model="log.createTime" type="datetime" format="yyyy-MM-dd HH:mm:ss" autocomplete="off" readonly />
            </el-form-item>
          </el-col>
        </el-row>
...
import { queryPageLogs } from '@/api/log'
...
export default {
  ...
  mounted() {
    this.queryEntity.username = this.suser
    this.handleFilter()
  },
